# BNDMAX VPN Subscription Guide

BNDMAX VPN provides an easy-to-use subscription system for configuring VLESS clients.

## Accessing Your Subscription

After deploying BNDMAX VPN, you can access your subscription configuration at:
```
...
BNDMAX VPN supports multiple UUIDs for different users or devices:
