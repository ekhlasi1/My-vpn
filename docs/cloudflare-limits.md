...
This document outlines the limits and quotas that apply to BNDMAX VPN when running on Cloudflare Workers.
...
By understanding and working within these limits, you can ensure a stable and performant BNDMAX VPN deployment on Cloudflare Workers.