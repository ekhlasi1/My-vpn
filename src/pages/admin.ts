  ...
  <div class="dash-wrap">
    ...
    <div class="tab-panel" id="tab-pool">
      <div class="glass" style="margin-bottom:1.2rem;">
        ...
        <p style="font-size:0.8rem; opacity:0.7; margin-bottom:0.8rem;">
          هر ردیف یک ورکر اضافه (روی همین اکانت یا یک اکانت کلادفلر کاملاً جدا) است. اگر فقط «آدرس ورکر» را پر کنید، مثل قبل
          فقط برای چرخاندن کانفیگ‌های VIP استفاده می‌شود. اگر Account ID و API Token و Database ID را هم بدهید، این پنل به‌صورت
          خودکار سلامت آن اکانت را از کلادفلر می‌پرسد و کاربران VIP را در دیتابیس همان اکانت هم می‌سازد — یعنی همان لینک اشتراک
          روی آن اکانت جداگانه هم کار می‌کند. تعداد اکانت قابل‌اضافه‌کردن نامحدود است.
        </p>
        <form class="settings-form" id="poolAddForm" style="margin-bottom:1rem;">
          ...
          <details style="margin:0.6rem 0;">
            <summary style="cursor:pointer; font-size:0.85rem; opacity:0.85;">تنظیمات پیشرفته اکانت کلادفلر (اختیاری — برای بررسی سلامت و ساخت خودکار کاربر روی اکانت جدا)</summary>
