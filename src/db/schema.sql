...
-- Extra Cloudflare Workers (running the same codebase, sharing this D1
-- database) that VIP users' extra configs can be pointed at, in rotating
-- rest/active batches — see getPoolRotation() in src/db/queries.ts (req. #4).
